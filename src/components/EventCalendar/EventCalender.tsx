...
const EventCalender = () => {
	return (
		<CalendarProvider>
			<section className="bg-transparent rounded-md">
				<div className="bg-sky-600 border border-red-200 w-full sm:w-40 h-40 rounded-full absolute top-1 opacity-80 max-sm:right-0 sm:left-56 z-0"></div>
