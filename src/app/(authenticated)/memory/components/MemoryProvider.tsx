...
const MemoryProvider: FC<IProps> = ({ children }) => {
	...
	return (
		<div className="w-full p-6 relative space-y-10 animate-in fade-in duration-500 h-full overflow-hidden grid grid-rows-12">
			<div className="h-full overflow-auto row-start-1 row-end-4 w-full">
				<div className="sticky top-0 flex flex-col md:flex-row md:items-end justify-between gap-6">
					<div>
			...
			<div className="row-start-4 row-end-13">{children}</div>
			{/*)}*/}
			{toggle && <CreateMemory />}
		</div>
	);
